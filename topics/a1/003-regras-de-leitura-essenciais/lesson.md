...
As combinações **ei** e **ie** são muito importantes. **ei** tem som parecido com **ai**, como em **mein** e **Zeit**. Já **ie** normalmente tem som de **i longo**, como em **sie** e **Liebe**.

As combinações **eu** e **äu** têm o mesmo som, parecido com **ói** em português. Você encontra esse som em **Deutsch**, **heute** e **Häuser**.

A combinação **ch** tem dois sons principais. Depois de **i, e, ä, ö, ü, ei, eu** aparece o som mais leve chamado **ich-Laut**, como em **ich**. Depois de **a, o, u, au** aparece o som mais forte chamado **ach-Laut**, como em **Buch** e **auch**.

A combinação **sch** tem som parecido com o **ch** de **chá**, como em **Schule**. No começo de muitas palavras, **sp** soa como **shp** e **st** soa como **sht**: **spielen**, **stehen**, **Straße**.
...
| Heute ist Deutschkurs. | Hoje é curso de alemão. | **eu** em **heute** e **Deutsch** tem o mesmo som. |
| Die Häuser sind klein. | As casas são pequenas. | **äu** soa como **eu**. |
| Ich lese. | Eu leio. | **ch** depois de **i** é ich-Laut. |
| Das Buch ist hier. | O livro está aqui. | **ch** depois de **u** é ach-Laut. |
| Die Schule ist groß. | A escola é grande. | **sch** soa como **ch** de chá. |
| Ich spiele. | Eu jogo. | **sp** no começo soa como **shp**. |
| Ich stehe hier. | Eu estou aqui. | **st** no começo soa como **sht**. |
| Die Zeit ist kurz. | O tempo é curto. | **z** soa como **ts**. |
...
- Confundir **eu** com som de **eu** português. Em alemão, **Deutsch** e **heute** têm som parecido com **ói**.
- Pronunciar todo **ch** da mesma forma. **ich** e **Buch** têm sons diferentes.
